...
.method public constructor <init>(Landroid/content/Context;Landroid/content/ComponentName;Landroid/support/v4/media/MediaBrowserCompat$ConnectionCallback;Landroid/os/Bundle;)V
    ...
    .line 685
    iput-object p0, p3, Landroid/support/v4/media/MediaBrowserCompat$ConnectionCallback;->b:Landroid/support/v4/media/MediaBrowserCompat$d;
...
.method public disconnect()V
    ...
    .line 2246
    :try_start_0
    invoke-virtual {v0, v2, v3, v1}, Landroid/support/v4/media/MediaBrowserCompat$i;->b(ILandroid/os/Bundle;Landroid/os/Messenger;)V
    :try_end_0
...
.method public getItem(Ljava/lang/String;Landroid/support/v4/media/MediaBrowserCompat$ItemCallback;)V
    ...
    invoke-direct {v0, p1, p2}, Landroid/support/v4/media/MediaBrowserCompat$d$a;-><init>(Ljava/lang/String;Landroid/support/v4/media/MediaBrowserCompat$ItemCallback;)V
    ...
    .line 1823
    new-instance v0, Landroid/support/v4/media/MediaBrowserCompat$d$b;

    invoke-direct {v0, p1, p2}, Landroid/support/v4/media/MediaBrowserCompat$d$b;-><init>(Ljava/lang/String;Landroid/support/v4/media/MediaBrowserCompat$ItemCallback;)V
    ...
    .line 1834
    :try_start_0
    iget-object v3, p0, Landroid/support/v4/media/MediaBrowserCompat$d;->g:Landroid/support/v4/media/MediaBrowserCompat$i;
    ...
    .line 2233
    invoke-virtual {v3, v0, v5, v4}, Landroid/support/v4/media/MediaBrowserCompat$i;->b(ILandroid/os/Bundle;Landroid/os/Messenger;)V
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
    ...
    .line 1837
    new-instance v0, Landroid/support/v4/media/MediaBrowserCompat$d$c;

    invoke-direct {v0, p1, p2}, Landroid/support/v4/media/MediaBrowserCompat$d$c;-><init>(Ljava/lang/String;Landroid/support/v4/media/MediaBrowserCompat$ItemCallback;)V
...
.method public onConnected()V
    ...
    iput v3, p0, Landroid/support/v4/media/MediaBrowserCompat$d;->f:I
    ...
    iput-object v4, p0, Landroid/support/v4/media/MediaBrowserCompat$d;->g:Landroid/support/v4/media/MediaBrowserCompat$i;
    ...
    iput-object v3, p0, Landroid/support/v4/media/MediaBrowserCompat$d;->h:Landroid/os/Messenger;
    ...
    iget-object v5, p0, Landroid/support/v4/media/MediaBrowserCompat$d;->h:Landroid/os/Messenger;
    ...
    iget-object v7, v3, Landroid/support/v4/media/MediaBrowserCompat$i;->b:Landroid/os/Bundle;
    ...
    .line 2242
    invoke-virtual {v3, v4, v6, v5}, Landroid/support/v4/media/MediaBrowserCompat$i;->b(ILandroid/os/Bundle;Landroid/os/Messenger;)V
    :try_end_1
...
.method public onConnectionSuspended()V
    ...
    iput-object v2, v1, Landroid/support/v4/media/MediaBrowserCompat$b;->b:Ljava/lang/ref/WeakReference;
...
.method public onLoadChildren(Landroid/os/Messenger;Ljava/lang/String;Ljava/util/List;Landroid/os/Bundle;Landroid/os/Bundle;)V
    ...
    .line 0
    invoke-static {p1, p2, p3}, L_COROUTINE/a;->C(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V

    return-void

    .line 1992
    :cond_1
    invoke-virtual {p1, p4}, Landroid/support/v4/media/MediaBrowserCompat$j;->getCallback(Landroid/os/Bundle;)Landroid/support/v4/media/MediaBrowserCompat$SubscriptionCallback;
...
.method public search(Ljava/lang/String;Landroid/os/Bundle;Landroid/support/v4/media/MediaBrowserCompat$SearchCallback;)V
    ...
    .line 1854
    new-instance v0, Landroid/support/v4/media/MediaBrowserCompat$d$d;

    invoke-direct {v0, p1, p2, p3}, Landroid/support/v4/media/MediaBrowserCompat$d$d;-><init>(Ljava/lang/String;Landroid/os/Bundle;Landroid/support/v4/media/MediaBrowserCompat$SearchCallback;)V
    ...
    .line 1869
    new-instance v0, Landroid/support/v4/media/MediaBrowserCompat$d$e;

    invoke-direct {v0, p1, p2, p3}, Landroid/support/v4/media/MediaBrowserCompat$d$e;-><init>(Ljava/lang/String;Landroid/os/Bundle;Landroid/support/v4/media/MediaBrowserCompat$SearchCallback;)V
...
.method public sendCustomAction(Ljava/lang/String;Landroid/os/Bundle;Landroid/support/v4/media/MediaBrowserCompat$CustomActionCallback;)V
    ...
    .line 1889
    new-instance v0, Landroid/support/v4/media/MediaBrowserCompat$d$f;

    invoke-direct {v0, p1, p2, p3}, Landroid/support/v4/media/MediaBrowserCompat$d$f;-><init>(Ljava/lang/String;Landroid/os/Bundle;Landroid/support/v4/media/MediaBrowserCompat$CustomActionCallback;)V
    ...
    .line 2261
    const-string v6, "data_custom_action"
    ...
    .line 1907
    new-instance v0, Landroid/support/v4/media/MediaBrowserCompat$d$g;

    invoke-direct {v0, p1, p2, p3}, Landroid/support/v4/media/MediaBrowserCompat$d$g;-><init>(Ljava/lang/String;Landroid/os/Bundle;Landroid/support/v4/media/MediaBrowserCompat$CustomActionCallback;)V
...
.method public subscribe(Ljava/lang/String;Landroid/os/Bundle;Landroid/support/v4/media/MediaBrowserCompat$SubscriptionCallback;)V
    ...
    invoke-direct {v1}, Landroid/support/v4/media/MediaBrowserCompat$j;-><init>()V
    ...
    iput-object v0, p3, Landroid/support/v4/media/MediaBrowserCompat$SubscriptionCallback;->c:Ljava/lang/ref/WeakReference;
    ...
    .line 1732
    :goto_0
    invoke-virtual {v1, p2, p3}, Landroid/support/v4/media/MediaBrowserCompat$j;->putCallback(Landroid/os/Bundle;Landroid/support/v4/media/MediaBrowserCompat$SubscriptionCallback;)V
    ...
    iget-object p3, p0, Landroid/support/v4/media/MediaBrowserCompat$d;->b:Landroid/media/browse/MediaBrowser;

    invoke-virtual {p3, p1, p2}, Landroid/media/browse/MediaBrowser;->subscribe(Ljava/lang/String;Landroid/media/browse/MediaBrowser$SubscriptionCallback;)V
    ...
    :cond_2
    :try_start_0
    iget-object p3, p3, Landroid/support/v4/media/MediaBrowserCompat$SubscriptionCallback;->b:Landroid/os/Binder;
    ...
    invoke-static {v2, v3, p3}, Landroidx/core/app/BundleCompat;->putBinder(Landroid/os/Bundle;Ljava/lang/String;Landroid/os/IBinder;)V

    .line 2215
    const-string p3, "data_options"

    invoke-virtual {v2, p3, p2}, Landroid/os/Bundle;->putBundle(Ljava/lang/String;Landroid/os/Bundle;)V

    const/4 p2, 0x3

    .line 2216
    invoke-virtual {v0, p2, v2, v1}, Landroid/support/v4/media/MediaBrowserCompat$i;->b(ILandroid/os/Bundle;Landroid/os/Messenger;)V
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
    ...
    .line 0
    invoke-static {p2, p1, p3}, L_COROUTINE/a;->y(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
...
.method public unsubscribe(Ljava/lang/String;Landroid/support/v4/media/MediaBrowserCompat$SubscriptionCallback;)V
    ...
    .line 1758
    iget-object v2, p0, Landroid/support/v4/media/MediaBrowserCompat$d;->b:Landroid/media/browse/MediaBrowser;

    if-nez p2, :cond_1

    .line 1759
    invoke-virtual {v2, p1}, Landroid/media/browse/MediaBrowser;->unsubscribe(Ljava/lang/String;)V
    ...
    invoke-virtual {v2, p1, v4, v3}, Landroid/support/v4/media/MediaBrowserCompat$i;->a(Ljava/lang/String;Landroid/os/Binder;Landroid/os/Messenger;)V
    ...
    .line 1784
    iget-object v5, p0, Landroid/support/v4/media/MediaBrowserCompat$d;->g:Landroid/support/v4/media/MediaBrowserCompat$i;

    iget-object v6, p2, Landroid/support/v4/media/MediaBrowserCompat$SubscriptionCallback;->b:Landroid/os/Binder;

    iget-object v7, p0, Landroid/support/v4/media/MediaBrowserCompat$d;->h:Landroid/os/Messenger;

    invoke-virtual {v5, p1, v6, v7}, Landroid/support/v4/media/MediaBrowserCompat$i;->a(Ljava/lang/String;Landroid/os/Binder;Landroid/os/Messenger;)V
    ...
    .line 0
    invoke-static {v2, p1, v3}, L_COROUTINE/a;->C(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V

    .line 1799
    :cond_7
    :goto_2
    invoke-virtual {v1}, Landroid/support/v4/media/MediaBrowserCompat$j;->isEmpty()Z
