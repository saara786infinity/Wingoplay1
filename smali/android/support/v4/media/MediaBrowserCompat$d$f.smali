...
.method public constructor <init>(Ljava/lang/String;Landroid/os/Bundle;Landroid/support/v4/media/MediaBrowserCompat$CustomActionCallback;)V
    ...
    iput-object p3, p0, Landroid/support/v4/media/MediaBrowserCompat$d$f;->a:Landroid/support/v4/media/MediaBrowserCompat$CustomActionCallback;

    iput-object p1, p0, Landroid/support/v4/media/MediaBrowserCompat$d$f;->b:Ljava/lang/String;

    iput-object p2, p0, Landroid/support/v4/media/MediaBrowserCompat$d$f;->c:Landroid/os/Bundle;
...
.method public run()V
    ...
    .line 1892
    iget-object v0, p0, Landroid/support/v4/media/MediaBrowserCompat$d$f;->c:Landroid/os/Bundle;

    const/4 v1, 0x0

    iget-object v2, p0, Landroid/support/v4/media/MediaBrowserCompat$d$f;->a:Landroid/support/v4/media/MediaBrowserCompat$CustomActionCallback;

    iget-object v3, p0, Landroid/support/v4/media/MediaBrowserCompat$d$f;->b:Ljava/lang/String;
