...
.method public final a(Landroid/view/KeyEvent;Landroid/support/v4/media/session/MediaSessionCompat$Callback;)V
    ...
    iget-object v0, v0, Landroid/support/v4/media/session/MediaSessionCompat$i;->h:Landroid/support/v4/media/session/PlaybackStateCompat;
...
.method public handleMessage(Landroid/os/Message;)V
    ...
    iget-object v0, v0, Landroid/support/v4/media/session/MediaSessionCompat$i;->c:Landroid/support/v4/media/session/MediaSessionCompat$Callback;
    ...
    .line 3588
    invoke-virtual {v2, v3}, Landroid/support/v4/media/session/MediaSessionCompat$i;->setCurrentControllerInfo(Landroidx/media/MediaSessionManager$RemoteUserInfo;)V
    ...
    iget-object v1, v1, Landroid/support/v4/media/session/MediaSessionCompat$i;->j:Ljava/util/List;
    ...
    .line 2941
    iget v1, v0, Landroid/support/v4/media/session/MediaSessionCompat$i;->q:I

    if-ne v1, v4, :cond_2

    .line 2942
    iget-object v0, v0, Landroid/support/v4/media/session/MediaSessionCompat$i;->s:Landroidx/media/VolumeProviderCompat;
    ...
    .line 3607
    invoke-virtual {p0, p1, v0}, Landroid/support/v4/media/session/MediaSessionCompat$i$d;->a(Landroid/view/KeyEvent;Landroid/support/v4/media/session/MediaSessionCompat$Callback;)V
    ...
    invoke-virtual {p1, v2}, Landroid/support/v4/media/session/MediaSessionCompat$i;->setCurrentControllerInfo(Landroidx/media/MediaSessionManager$RemoteUserInfo;)V
    ...
    invoke-virtual {v0, v2}, Landroid/support/v4/media/session/MediaSessionCompat$i;->setCurrentControllerInfo(Landroidx/media/MediaSessionManager$RemoteUserInfo;)V
