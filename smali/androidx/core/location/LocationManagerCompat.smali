...
.method public static a(Landroid/location/LocationManager;Ljava/util/concurrent/Executor;Landroid/location/GnssMeasurementsEvent$Callback;)Z
    .locals 7
    ...
    sget-object v3, Landroidx/core/location/LocationManagerCompat;->b:Ljava/lang/reflect/Method;

    sget-object v4, Landroidx/core/location/LocationManagerCompat;->a:Ljava/lang/Class;
...
.method public static b(Landroid/location/LocationManager;Landroidx/core/location/LocationManagerCompat$l;)V
    ...
    .line 269
    invoke-virtual {p1}, Landroidx/core/location/LocationManagerCompat$l;->getKey()Landroidx/core/location/LocationManagerCompat$k;
    ...
    .line 272
    invoke-virtual {p1}, Landroidx/core/location/LocationManagerCompat$l;->unregister()V
...
.method public static getCurrentLocation(Landroid/location/LocationManager;Ljava/lang/String;Landroidx/core/os/CancellationSignal;Ljava/util/concurrent/Executor;Landroidx/core/util/Consumer;)V
    ...
    invoke-direct {p0, v6}, Landroidx/core/location/d;-><init>(Landroidx/core/location/LocationManagerCompat$f;)V
    ...
    .line 216
    invoke-virtual {v6, p0, p1}, Landroidx/core/location/LocationManagerCompat$f;->startTimeout(J)V
...
.method public static registerGnssMeasurementsCallback(Landroid/location/LocationManager;Landroid/location/GnssMeasurementsEvent$Callback;Landroid/os/Handler;)Z
    ...
    .line 393
    invoke-static {p0, p1, p2}, Landroidx/core/location/LocationManagerCompat$b;->a(Landroid/location/LocationManager;Landroid/location/GnssMeasurementsEvent$Callback;Landroid/os/Handler;)Z
    ...
    .line 395
    invoke-static {p0, p2, p1}, Landroidx/core/location/LocationManagerCompat;->a(Landroid/location/LocationManager;Ljava/util/concurrent/Executor;Landroid/location/GnssMeasurementsEvent$Callback;)Z
...
.method public static registerGnssMeasurementsCallback(Landroid/location/LocationManager;Ljava/util/concurrent/Executor;Landroid/location/GnssMeasurementsEvent$Callback;)Z
    ...
    .line 417
    :cond_0
    invoke-static {p0, p1, p2}, Landroidx/core/location/LocationManagerCompat;->a(Landroid/location/LocationManager;Ljava/util/concurrent/Executor;Landroid/location/GnssMeasurementsEvent$Callback;)Z
...
.method public static registerGnssStatusCallback(Landroid/location/LocationManager;Ljava/util/concurrent/Executor;Landroidx/core/location/GnssStatusCompat$Callback;)Z
    ...
    .line 529
    invoke-static {p0, v2, p1, p2}, Landroidx/core/location/LocationManagerCompat$d;->registerGnssStatusCallback(Landroid/location/LocationManager;Landroid/os/Handler;Ljava/util/concurrent/Executor;Landroidx/core/location/GnssStatusCompat$Callback;)Z
    ...
    .line 532
    :cond_0
    invoke-static {p0, v2, p1, p2}, Landroidx/core/location/LocationManagerCompat$b;->b(Landroid/location/LocationManager;Landroid/os/Handler;Ljava/util/concurrent/Executor;Landroidx/core/location/GnssStatusCompat$Callback;)Z
    ...
    .line 529
    invoke-static {p0, v3, p1, p2}, Landroidx/core/location/LocationManagerCompat$d;->registerGnssStatusCallback(Landroid/location/LocationManager;Landroid/os/Handler;Ljava/util/concurrent/Executor;Landroidx/core/location/GnssStatusCompat$Callback;)Z
    ...
    .line 532
    :cond_3
    invoke-static {p0, v3, p1, p2}, Landroidx/core/location/LocationManagerCompat$b;->b(Landroid/location/LocationManager;Landroid/os/Handler;Ljava/util/concurrent/Executor;Landroidx/core/location/GnssStatusCompat$Callback;)Z
...
.method public static removeUpdates(Landroid/location/LocationManager;Landroidx/core/location/LocationListenerCompat;)V
    ...
    .line 323
    :cond_1
    invoke-virtual {v3}, Landroidx/core/location/LocationManagerCompat$l;->getKey()Landroidx/core/location/LocationManagerCompat$k;
    ...
    .line 329
    invoke-virtual {v3}, Landroidx/core/location/LocationManagerCompat$l;->unregister()V
...
.method public static requestLocationUpdates(Landroid/location/LocationManager;Ljava/lang/String;Landroidx/core/location/LocationRequestCompat;Ljava/util/concurrent/Executor;Landroidx/core/location/LocationListenerCompat;)V
    ...
    .line 243
    invoke-static {p0, p1, p2, p3, p4}, Landroidx/core/location/LocationManagerCompat$d;->tryRequestLocationUpdates(Landroid/location/LocationManager;Ljava/lang/String;Landroidx/core/location/LocationRequestCompat;Ljava/util/concurrent/Executor;Landroidx/core/location/LocationListenerCompat;)Z
    ...
    .line 248
    :cond_1
    new-instance v6, Landroidx/core/location/LocationManagerCompat$l;

    new-instance v0, Landroidx/core/location/LocationManagerCompat$k;

    invoke-direct {v0, p1, p4}, Landroidx/core/location/LocationManagerCompat$k;-><init>(Ljava/lang/String;Landroidx/core/location/LocationListenerCompat;)V

    invoke-direct {v6, v0, p3}, Landroidx/core/location/LocationManagerCompat$l;-><init>(Landroidx/core/location/LocationManagerCompat$k;Ljava/util/concurrent/Executor;)V

    .line 251
    invoke-static {p0, p1, p2, v6}, Landroidx/core/location/LocationManagerCompat$a;->b(Landroid/location/LocationManager;Ljava/lang/String;Landroidx/core/location/LocationRequestCompat;Landroidx/core/location/LocationManagerCompat$l;)Z
    ...
    .line 260
    invoke-static {v1, v6}, Landroidx/core/location/LocationManagerCompat;->b(Landroid/location/LocationManager;Landroidx/core/location/LocationManagerCompat$l;)V
...
.method public static unregisterGnssMeasurementsCallback(Landroid/location/LocationManager;Landroid/location/GnssMeasurementsEvent$Callback;)V
    ...
    .line 430
    invoke-static {p0, p1}, Landroidx/core/location/LocationManagerCompat$b;->c(Landroid/location/LocationManager;Landroid/location/GnssMeasurementsEvent$Callback;)V
...
.method public static unregisterGnssStatusCallback(Landroid/location/LocationManager;Landroidx/core/location/GnssStatusCompat$Callback;)V
    ...
    .line 606
    invoke-static {p0, p1}, Landroidx/core/location/LocationManagerCompat$b;->d(Landroid/location/LocationManager;Ljava/lang/Object;)V
