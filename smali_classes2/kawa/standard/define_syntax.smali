...
.method public scanForm(Lgnu/lists/Pair;Lgnu/expr/ScopeExp;Lkawa/lang/Translator;)V
    ...
    .line 53
    :goto_0
    instance-of v6, v3, Lkawa/lang/SyntaxForm;
    ...
    .line 74
    :cond_2
    invoke-virtual {p3, v4}, Lkawa/lang/Translator;->namespaceResolve(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    .line 80
    invoke-static {v3}, Lkawa/lang/Translator;->safeCdr(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    .line 86
    :cond_4
    invoke-virtual {p3, v4, v6, p2}, Lkawa/lang/Translator;->define(Ljava/lang/Object;Lkawa/lang/SyntaxForm;Lgnu/expr/ScopeExp;)Lgnu/expr/Declaration;

    move-result-object p1

    .line 87
    sget-object v6, Lkawa/standard/define_syntax;->typeMacro:Lgnu/bytecode/ClassType;

    invoke-virtual {p1, v6}, Lgnu/expr/Declaration;->setType(Lgnu/bytecode/Type;)V

    .line 88
    invoke-virtual {p3, p1}, Lgnu/expr/Compilation;->push(Lgnu/expr/Declaration;)V

    .line 90
    iget-object v6, p3, Lkawa/lang/Translator;->currentMacroDefinition:Lkawa/lang/Macro;
    ...
    .line 92
    iget-boolean v8, p0, Lkawa/standard/define_syntax;->hygienic:Z

    invoke-virtual {v7, v8}, Lkawa/lang/Macro;->setHygienic(Z)V

    .line 93
    iput-object v7, p3, Lkawa/lang/Translator;->currentMacroDefinition:Lkawa/lang/Macro;

    .line 94
    check-cast v3, Lgnu/lists/Pair;

    invoke-virtual {p3, v3, v5}, Lkawa/lang/Translator;->rewrite_car(Lgnu/lists/Pair;Lkawa/lang/SyntaxForm;)Lgnu/expr/Expression;

    move-result-object v3

    .line 95
    iput-object v6, p3, Lkawa/lang/Translator;->currentMacroDefinition:Lkawa/lang/Macro;

    .line 96
    iput-object v3, v7, Lkawa/lang/Macro;->expander:Ljava/lang/Object;
    ...
    invoke-virtual {v5, v6}, Lgnu/expr/Expression;->setFlag(I)V
    ...
    iget-boolean v4, p0, Lkawa/standard/define_syntax;->hygienic:Z

    if-eqz v4, :cond_6

    sget-object v4, Lkawa/standard/define_syntax;->makeHygienic:Lgnu/expr/PrimProcedure;

    goto :goto_2

    :cond_6
    sget-object v4, Lkawa/standard/define_syntax;->makeNonHygienic:Lgnu/expr/PrimProcedure;

    :goto_2
    invoke-direct {v3, v4, v6}, Lgnu/expr/ApplyExp;-><init>(Lgnu/mapping/Procedure;[Lgnu/expr/Expression;)V

    .line 106
    invoke-virtual {p1, v3}, Lgnu/expr/Declaration;->noteValue(Lgnu/expr/Expression;)V

    .line 107
    invoke-virtual {p1, v2}, Lgnu/expr/Declaration;->setProcedureDecl(Z)V
    ...
    invoke-direct {v4, p1, v3}, Lgnu/expr/SetExp;-><init>(Lgnu/expr/Declaration;Lgnu/expr/Expression;)V

    .line 112
    invoke-virtual {v4, v2}, Lgnu/expr/SetExp;->setDefining(Z)V
    ...
    .line 114
    invoke-virtual {v4, v2}, Lgnu/expr/SetExp;->setFuncDef(Z)V
    ...
    .line 118
    iget-boolean v3, p3, Lgnu/expr/Compilation;->immediate:Z
    ...
    new-array p2, v0, [Lgnu/expr/Expression;
    ...
    invoke-virtual {p3, p2}, Lgnu/expr/Compilation;->syntaxError(Ljava/lang/String;)Lgnu/expr/Expression;
