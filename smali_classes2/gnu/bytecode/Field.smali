...
# virtual methods
.method public assign_constants(Lgnu/bytecode/ClassType;)V
    .locals 2
    ...
    .line 74
    iget v1, p0, Lgnu/bytecode/Location;->name_index:I

    if-nez v1, :cond_0

    iget-object v1, p0, Lgnu/bytecode/Location;->name:Ljava/lang/String;
    ...
    iput v1, p0, Lgnu/bytecode/Location;->name_index:I

    .line 76
    :cond_0
    iget v1, p0, Lgnu/bytecode/Location;->signature_index:I

    if-nez v1, :cond_1

    iget-object v1, p0, Lgnu/bytecode/Location;->type:Lgnu/bytecode/Type;
    ...
    iput v0, p0, Lgnu/bytecode/Location;->signature_index:I
...
.method public declared-synchronized getReflectField()Ljava/lang/reflect/Field;
    ...
    invoke-virtual {p0}, Lgnu/bytecode/Location;->getName()Ljava/lang/String;
...
.method public final setConstantValue(Ljava/lang/Object;Lgnu/bytecode/ClassType;)V
    ...
    .line 131
    :cond_0
    invoke-virtual {p0}, Lgnu/bytecode/Location;->getType()Lgnu/bytecode/Type;
    ...
    .line 159
    invoke-virtual {p2, p0}, Lgnu/bytecode/Attribute;->addToFrontOf(Lgnu/bytecode/AttrContainer;)V
...
.method public write(Ljava/io/DataOutputStream;Lgnu/bytecode/ClassType;)V
    .locals 0
    .annotation system Ldalvik/annotation/Throws;
        value = {
    ...
    .line 65
    iget p2, p0, Lgnu/bytecode/Location;->name_index:I

    invoke-virtual {p1, p2}, Ljava/io/DataOutputStream;->writeShort(I)V

    .line 66
    iget p2, p0, Lgnu/bytecode/Location;->signature_index:I
