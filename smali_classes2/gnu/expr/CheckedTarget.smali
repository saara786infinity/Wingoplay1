...
.method public constructor <init>(Lgnu/bytecode/Type;Lgnu/expr/LambdaExp;I)V
    ...
    .line 30
    invoke-virtual {p2}, Lgnu/mapping/PropertySet;->getName()Ljava/lang/String;
...
.method public static emitCheckedCoerce(Lgnu/expr/Compilation;Lgnu/expr/LambdaExp;Ljava/lang/String;ILgnu/bytecode/Type;Lgnu/bytecode/Variable;)V
    .locals 10
    ...
    .line 143
    invoke-static {p4, p0}, Lgnu/expr/StackTarget;->emitCoerceFromObject(Lgnu/bytecode/Type;Lgnu/expr/Compilation;)V
...
.method private static initWrongType()V
    ...
    .line 71
    sget-object v5, Lgnu/expr/CheckedTarget;->typeClassCastException:Lgnu/bytecode/ClassType;

    if-nez v5, :cond_0

    .line 72
    const-string v5, "java.lang.ClassCastException"

    invoke-static {v5}, Lgnu/bytecode/ClassType;->make(Ljava/lang/String;)Lgnu/bytecode/ClassType;

    move-result-object v5

    sput-object v5, Lgnu/expr/CheckedTarget;->typeClassCastException:Lgnu/bytecode/ClassType;

    .line 73
    :cond_0
    sget-object v5, Lgnu/expr/CheckedTarget;->typeWrongType:Lgnu/bytecode/ClassType;

    if-nez v5, :cond_1

    .line 75
    const-string v5, "gnu.mapping.WrongType"

    invoke-static {v5}, Lgnu/bytecode/ClassType;->make(Ljava/lang/String;)Lgnu/bytecode/ClassType;

    move-result-object v5

    sput-object v5, Lgnu/expr/CheckedTarget;->typeWrongType:Lgnu/bytecode/ClassType;
    ...
    .line 81
    sget-object v8, Lgnu/expr/CheckedTarget;->typeWrongType:Lgnu/bytecode/ClassType;

    sget-object v9, Lgnu/bytecode/Type;->voidType:Lgnu/bytecode/PrimType;

    const-string v10, "<init>"

    invoke-virtual {v8, v10, v4, v7, v9}, Lgnu/bytecode/ClassType;->addMethod(Ljava/lang/String;I[Lgnu/bytecode/Type;Lgnu/bytecode/Type;)Lgnu/bytecode/Method;

    move-result-object v7

    sput-object v7, Lgnu/expr/CheckedTarget;->initWrongTypeStringMethod:Lgnu/bytecode/Method;

    .line 88
    new-array v3, v3, [Lgnu/bytecode/Type;

    sget-object v7, Lgnu/expr/CheckedTarget;->typeClassCastException:Lgnu/bytecode/ClassType;
    ...
    invoke-virtual {v0, v10, v4, v3, v9}, Lgnu/bytecode/ClassType;->addMethod(Ljava/lang/String;I[Lgnu/bytecode/Type;Lgnu/bytecode/Type;)Lgnu/bytecode/Method;
...
.method public compileFromStack(Lgnu/expr/Compilation;Lgnu/bytecode/Type;)V
    ...
    iget-object v4, p0, Lgnu/expr/StackTarget;->type:Lgnu/bytecode/Type;
