...
.method public static final evalModule1(Lgnu/mapping/Environment;Lgnu/expr/Compilation;Ljava/net/URL;Lgnu/mapping/OutPort;)Ljava/lang/Object;
    ...
    .line 214
    const-string v0, "[Evaluating final module \""
    ...
    .line 215
    iget-object v2, p1, Lgnu/expr/Compilation;->minfo:Lgnu/expr/ModuleInfo;

    iput-object v2, v1, Lgnu/expr/ModuleExp;->info:Lgnu/expr/ModuleInfo;
    ...
    .line 227
    sget-boolean v4, Lgnu/expr/ModuleExp;->alwaysCompile:Z

    if-eqz v4, :cond_1

    sget-boolean v4, Lgnu/expr/ModuleExp;->neverCompile:Z
    ...
    .line 237
    :try_start_0
    invoke-virtual {p1, v4}, Lgnu/expr/Compilation;->process(I)V

    .line 238
    iget-object v4, p1, Lgnu/expr/Compilation;->minfo:Lgnu/expr/ModuleInfo;

    const/16 v6, 0x8

    invoke-virtual {v4, v6}, Lgnu/expr/ModuleInfo;->loadByStages(I)V
    ...
    .line 240
    invoke-virtual {v3, p3, v4}, Lgnu/text/SourceMessages;->checkErrors(Ljava/io/PrintWriter;I)Z
    ...
    .line 253
    invoke-virtual {v1, p3}, Lgnu/expr/ModuleExp;->print(Lgnu/mapping/OutPort;)V

    const/16 p1, 0x5d

    .line 254
    invoke-virtual {p3, p1}, Ljava/io/PrintWriter;->println(C)V
    ...
    :goto_2
    :try_start_5
    iput-object v5, v1, Lgnu/expr/LambdaExp;->body:Lgnu/expr/Expression;

    .line 276
    iput-object v5, v1, Lgnu/expr/LambdaExp;->thisVariable:Lgnu/bytecode/Variable;
...
.method public static final evalModule2(Lgnu/mapping/Environment;Lgnu/mapping/CallContext;Lgnu/expr/Language;Lgnu/expr/ModuleExp;Ljava/lang/Object;)V
    ...
    .line 304
    iget-object p0, p3, Lgnu/expr/LambdaExp;->body:Lgnu/expr/Expression;
    ...
    invoke-virtual {v1}, Lgnu/bytecode/Location;->getName()Ljava/lang/String;
    ...
    .line 370
    invoke-virtual {v3, p3}, Lgnu/kawa/reflect/FieldLocation;->setDeclaration(Lgnu/expr/Declaration;)V
...
.method public static evalToClass(Lgnu/expr/Compilation;Ljava/net/URL;)Ljava/lang/Class;
    ...
    .line 122
    invoke-virtual {v7, v8}, Lgnu/bytecode/Type;->setReflectClass(Ljava/lang/Class;)V

    .line 123
    invoke-virtual {v7, v3}, Lgnu/bytecode/ObjectType;->setExisting(Z)V
    ...
    invoke-virtual {p0, v2, v1, p1}, Lgnu/text/SourceMessages;->error(CLjava/lang/String;Ljava/lang/Throwable;)V
...
.method public allocFields(Lgnu/expr/Compilation;)V
    .locals 9
...
.method public classFor(Lgnu/expr/Compilation;)Lgnu/bytecode/ClassType;
    ...
    .line 546
    :cond_2
    iget-object v1, p0, Lgnu/expr/Expression;->filename:Ljava/lang/String;
    ...
    .line 0
    invoke-static {v1, v2, v0}, L_COROUTINE/a;->n(Ljava/lang/StringBuilder;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    .line 581
    invoke-virtual {p0, v1}, Lgnu/expr/LambdaExp;->setType(Lgnu/bytecode/ClassType;)V
    ...
    .line 587
    const-string v2, "inconsistent main class name: "

    const-string v3, " - old name: "

    .line 0
    invoke-static {v2, v0, v3}, L_COROUTINE/a;->t(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/StringBuilder;
