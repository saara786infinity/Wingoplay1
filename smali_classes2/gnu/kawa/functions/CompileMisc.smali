...
.method public static compileCallCC(Lgnu/expr/ApplyExp;Lgnu/expr/Compilation;Lgnu/expr/Target;Lgnu/mapping/Procedure;)V
    ...
    .line 323
    invoke-virtual {v2, v0}, Lgnu/expr/Declaration;->setCanCall(Z)V
    ...
    .line 326
    :cond_1
    iget-object v5, v1, Lgnu/expr/LambdaExp;->body:Lgnu/expr/Expression;

    invoke-static {v2, v5}, Lgnu/kawa/functions/CompileMisc$ExitThroughFinallyChecker;->check(Lgnu/expr/Declaration;Lgnu/expr/Expression;)Z
    ...
    .line 329
    iput-object v4, v3, Lgnu/kawa/functions/CompileTimeContinuation;->exitableBlock:Lgnu/bytecode/ExitableBlock;
    ...
    invoke-virtual {v2, v4}, Lgnu/expr/Declaration;->setValue(Lgnu/expr/Expression;)V
    ...
    invoke-direct {v2, v1, p3}, Lgnu/expr/ApplyExp;-><init>(Lgnu/expr/Expression;[Lgnu/expr/Expression;)V

    invoke-virtual {v2, p1, p2}, Lgnu/expr/ApplyExp;->compile(Lgnu/expr/Compilation;Lgnu/expr/Target;)V
    ...
    .line 338
    sget-object v3, Lgnu/kawa/functions/CompileMisc;->typeContinuation:Lgnu/bytecode/ClassType;

    invoke-virtual {v2, p0, v3, v4}, Lgnu/bytecode/Scope;->addVariable(Lgnu/bytecode/CodeAttr;Lgnu/bytecode/Type;Ljava/lang/String;)Lgnu/bytecode/Variable;
    ...
    invoke-direct {v5, v2}, Lgnu/expr/Declaration;-><init>(Lgnu/bytecode/Variable;)V

    .line 340
    invoke-virtual {p0, v3}, Lgnu/bytecode/CodeAttr;->emitNew(Lgnu/bytecode/ClassType;)V

    .line 341
    invoke-virtual {p0, v3}, Lgnu/bytecode/CodeAttr;->emitDup(Lgnu/bytecode/Type;)V
    ...
    invoke-virtual {v3, v6, p3}, Lgnu/bytecode/ClassType;->getDeclaredMethod(Ljava/lang/String;I)Lgnu/bytecode/Method;
    ...
    :goto_1
    invoke-virtual {p0, v0, v6}, Lgnu/bytecode/CodeAttr;->emitTryStart(ZLgnu/bytecode/Type;)V
    ...
    new-array v5, p3, [Lgnu/expr/Expression;

    aput-object v7, v5, v0

    invoke-direct {v6, v1, v5}, Lgnu/expr/ApplyExp;-><init>(Lgnu/expr/Expression;[Lgnu/expr/Expression;)V
    ...
    .line 352
    invoke-virtual {p0, p3}, Lgnu/bytecode/CodeAttr;->emitPushInt(I)V

    .line 353
    const-string p3, "invoked"

    invoke-virtual {v3, p3}, Lgnu/bytecode/ClassType;->getField(Ljava/lang/String;)Lgnu/bytecode/Field;
    ...
    invoke-virtual {v3, p1, p2}, Lgnu/bytecode/ClassType;->getDeclaredMethod(Ljava/lang/String;I)Lgnu/bytecode/Method;
    ...
    .line 368
    :cond_6
    const-string p3, "handleException"

    const/4 v0, 0x2

    invoke-virtual {v3, p3, v0}, Lgnu/bytecode/ClassType;->getDeclaredMethod(Ljava/lang/String;I)Lgnu/bytecode/Method;
...
.method public static validateApplyCallCC(Lgnu/expr/ApplyExp;Lgnu/expr/InlineCalls;Lgnu/bytecode/Type;Lgnu/mapping/Procedure;)Lgnu/expr/Expression;
    ...
    .line 300
    invoke-virtual {p2}, Lgnu/expr/ScopeExp;->firstDecl()Lgnu/expr/Declaration;
...
.method public static validateApplyConstantFunction0(Lgnu/expr/ApplyExp;Lgnu/expr/InlineCalls;Lgnu/bytecode/Type;Lgnu/mapping/Procedure;)Lgnu/expr/Expression;
    ...
    .line 55
    invoke-virtual {p1, p0}, Lgnu/expr/ExpVisitor;->noteError(Ljava/lang/String;)Lgnu/expr/Expression;
...
.method public static validateApplyFormat(Lgnu/expr/ApplyExp;Lgnu/expr/InlineCalls;Lgnu/bytecode/Type;Lgnu/mapping/Procedure;)Lgnu/expr/Expression;
    ...
    sget-object v5, Lgnu/kawa/lispexpr/LangObjType;->stringType:Lgnu/kawa/lispexpr/LangObjType;

    invoke-virtual {v2, v5}, Lgnu/bytecode/Type;->isSubtype(Lgnu/bytecode/Type;)Z
    ...
    const-string v5, "java.io.Writer"
    ...
    const-string p1, "formatToWriter"

    const/4 v0, 0x3

    invoke-virtual {p3, p1, v0}, Lgnu/bytecode/ClassType;->getDeclaredMethod(Ljava/lang/String;I)Lgnu/bytecode/Method;
    ...
    const-string p1, "formatToString"

    const/4 p2, 0x2

    invoke-virtual {p3, p1, p2}, Lgnu/bytecode/ClassType;->getDeclaredMethod(Ljava/lang/String;I)Lgnu/bytecode/Method;
...
.method public static validateApplyMakeProcedure(Lgnu/expr/ApplyExp;Lgnu/expr/InlineCalls;Lgnu/bytecode/Type;Lgnu/mapping/Procedure;)Lgnu/expr/Expression;
    ...
    .line 201
    invoke-virtual {p0, v1}, Lgnu/mapping/PropertySet;->setName(Ljava/lang/String;)V
...
.method public static validateApplyMap(Lgnu/expr/ApplyExp;Lgnu/expr/InlineCalls;Lgnu/bytecode/Type;Lgnu/mapping/Procedure;)Lgnu/expr/Expression;
    ...
    check-cast v3, Lgnu/kawa/functions/Map;

    .line 432
    iget-boolean v4, v3, Lgnu/kawa/functions/Map;->collect:Z
    ...
    .line 447
    invoke-virtual {v9}, Lgnu/expr/Expression;->side_effects()Z

    move-result v10

    .line 451
    filled-new-array {v9}, [Lgnu/expr/Expression;
    ...
    invoke-direct {v12, v11}, Lgnu/expr/LetExp;-><init>([Lgnu/expr/Expression;)V
    ...
    invoke-virtual {v12, v11, v13}, Lgnu/expr/ScopeExp;->addDeclaration(Ljava/lang/Object;Lgnu/bytecode/Type;)Lgnu/expr/Declaration;
    ...
    .line 458
    new-array v13, v2, [Lgnu/expr/Expression;
    ...
    .line 460
    invoke-virtual {v12, v14}, Lgnu/expr/LetExp;->setBody(Lgnu/expr/Expression;)V
    ...
    :goto_0
    invoke-direct {v15, v1}, Lgnu/expr/LambdaExp;-><init>(I)V
    ...
    invoke-virtual {v14, v1}, Lgnu/expr/ScopeExp;->addDeclaration(Ljava/lang/Object;)Lgnu/expr/Declaration;

    move-result-object v1

    .line 464
    invoke-virtual {v1, v15}, Lgnu/expr/Declaration;->noteValue(Lgnu/expr/Expression;)V
    ...
    invoke-direct {v2, v13}, Lgnu/expr/LetExp;-><init>([Lgnu/expr/Expression;)V

    .line 470
    new-array v7, v8, [Lgnu/expr/Declaration;

    move/from16 v17, v4

    .line 471
    new-array v4, v8, [Lgnu/expr/Declaration;
    ...
    .line 0
    invoke-static {v4, v5}, L_COROUTINE/a;->c(ILjava/lang/String;)Ljava/lang/String;

    move-result-object v5

    .line 475
    invoke-virtual {v15, v5}, Lgnu/expr/ScopeExp;->addDeclaration(Ljava/lang/Object;)Lgnu/expr/Declaration;
    ...
    .line 476
    sget-object v4, Lgnu/expr/Compilation;->typePair:Lgnu/bytecode/ClassType;

    invoke-virtual {v2, v5, v4}, Lgnu/expr/ScopeExp;->addDeclaration(Ljava/lang/Object;Lgnu/bytecode/Type;)Lgnu/expr/Declaration;

    move-result-object v4

    aput-object v4, p0, v19
    ...
    .line 481
    :goto_2
    new-array v13, v6, [Lgnu/expr/Expression;
    ...
    aget-object v7, p0, v22

    invoke-direct {v6, v7}, Lgnu/expr/ReferenceExp;-><init>(Lgnu/expr/Declaration;)V

    const-string v7, "car"

    invoke-static {v6, v7}, Lgnu/kawa/reflect/SlotGet;->makeGetField(Lgnu/expr/Expression;Ljava/lang/String;)Lgnu/expr/ApplyExp;

    move-result-object v6

    const/4 v7, 0x0

    invoke-virtual {v0, v6, v7}, Lgnu/expr/InlineCalls;->visitApplyOnly(Lgnu/expr/ApplyExp;Lgnu/bytecode/Type;)Lgnu/expr/Expression;
    ...
    iget-object v9, v3, Lgnu/kawa/functions/Map;->applyFieldDecl:Lgnu/expr/Declaration;

    invoke-direct {v7, v9}, Lgnu/expr/ReferenceExp;-><init>(Lgnu/expr/Declaration;)V

    invoke-direct {v6, v7, v13}, Lgnu/expr/ApplyExp;-><init>(Lgnu/expr/Expression;[Lgnu/expr/Expression;)V
    ...
    new-array v11, v9, [Lgnu/expr/Expression;
    ...
    .line 497
    sget-object v7, Lgnu/expr/Compilation;->typePair:Lgnu/bytecode/ClassType;

    const-string v9, "make"

    invoke-static {v7, v9, v11}, Lgnu/kawa/reflect/Invoke;->makeInvokeStatic(Lgnu/bytecode/ClassType;Ljava/lang/String;[Lgnu/expr/Expression;)Lgnu/expr/ApplyExp;
    ...
    invoke-direct {v9, v1}, Lgnu/expr/ReferenceExp;-><init>(Lgnu/expr/Declaration;)V

    invoke-direct {v7, v9, v4}, Lgnu/expr/ApplyExp;-><init>(Lgnu/expr/Expression;[Lgnu/expr/Expression;)V

    const/4 v4, 0x0

    invoke-virtual {v0, v7, v4}, Lgnu/expr/InlineCalls;->visitApplyOnly(Lgnu/expr/ApplyExp;Lgnu/bytecode/Type;)Lgnu/expr/Expression;
    ...
    invoke-direct {v4, v6, v7}, Lgnu/expr/BeginExp;-><init>(Lgnu/expr/Expression;Lgnu/expr/Expression;)V

    move-object v7, v4

    :goto_5
    iput-object v7, v15, Lgnu/expr/LambdaExp;->body:Lgnu/expr/Expression;

    .line 502
    invoke-virtual {v2, v7}, Lgnu/expr/LetExp;->setBody(Lgnu/expr/Expression;)V

    .line 503
    iput-object v2, v15, Lgnu/expr/LambdaExp;->body:Lgnu/expr/Expression;
    ...
    iget-object v5, v3, Lgnu/kawa/functions/Map;->isEq:Lgnu/kawa/functions/IsEq;

    invoke-direct {v4, v5, v13}, Lgnu/expr/ApplyExp;-><init>(Lgnu/mapping/Procedure;[Lgnu/expr/Expression;)V

    const/4 v5, 0x0

    invoke-virtual {v0, v4, v5}, Lgnu/expr/InlineCalls;->visitApplyOnly(Lgnu/expr/ApplyExp;Lgnu/bytecode/Type;)Lgnu/expr/Expression;

    move-result-object v4

    iget-object v5, v15, Lgnu/expr/LambdaExp;->body:Lgnu/expr/Expression;

    invoke-direct {v11, v4, v9, v5}, Lgnu/expr/IfExp;-><init>(Lgnu/expr/Expression;Lgnu/expr/Expression;Lgnu/expr/Expression;)V

    iput-object v11, v15, Lgnu/expr/LambdaExp;->body:Lgnu/expr/Expression;
    ...
    invoke-direct {v4, v1}, Lgnu/expr/ReferenceExp;-><init>(Lgnu/expr/Declaration;)V
    ...
    .line 526
    sget-object v1, Lgnu/expr/Compilation;->scmListType:Lgnu/bytecode/ClassType;

    const-string v2, "reverseInPlace"

    invoke-static {v1, v2, v0}, Lgnu/kawa/reflect/Invoke;->makeInvokeStatic(Lgnu/bytecode/ClassType;Ljava/lang/String;[Lgnu/expr/Expression;)Lgnu/expr/ApplyExp;

    move-result-object v0

    .line 529
    :cond_d
    invoke-virtual {v14, v0}, Lgnu/expr/LetExp;->setBody(Lgnu/expr/Expression;)V
