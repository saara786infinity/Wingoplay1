...
.method public maybeSendResponseHeaders(I)V
    .locals 6
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
    ...
    iget v1, v0, Lgnu/kawa/servlet/HttpRequestContext;->statusCode:I
    ...
    .line 139
    iget-object v3, v0, Lgnu/kawa/servlet/HttpRequestContext;->statusReasonPhrase:Ljava/lang/String;

    int-to-long v4, p1

    invoke-virtual {v0, v1, v3, v4, v5}, Lgnu/kawa/servlet/HttpRequestContext;->sendResponseHeaders(ILjava/lang/String;J)V

    .line 140
    iget-object p1, p0, Lgnu/kawa/servlet/HttpOutputStream;->context:Lgnu/kawa/servlet/HttpRequestContext;

    iput v2, p1, Lgnu/kawa/servlet/HttpRequestContext;->statusCode:I
