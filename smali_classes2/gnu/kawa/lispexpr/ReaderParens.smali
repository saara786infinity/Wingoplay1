...
.method public static readList(Lgnu/kawa/lispexpr/LispReader;III)Ljava/lang/Object;
    ...
    .line 80
    invoke-virtual {v1}, Lgnu/text/Lexer;->getPort()Lgnu/text/LineBufferedReader;
    ...
    .line 87
    :try_start_0
    invoke-virtual {v1}, Lgnu/kawa/lispexpr/LispReader;->makeNil()Ljava/lang/Object;
    ...
    .line 99
    :try_start_1
    invoke-virtual {v1, v8, v9, v5}, Lgnu/text/Lexer;->eofError(Ljava/lang/String;II)V
    ...
    .line 104
    invoke-virtual/range {v16 .. v16}, Lgnu/text/LineBufferedReader;->peek()I
    ...
    :cond_4
    :goto_4
    invoke-virtual/range {v16 .. v16}, Lgnu/text/LineBufferedReader;->skip()V
    ...
    invoke-virtual {v1, v0}, Lgnu/text/Lexer;->error(Ljava/lang/String;)V
    :try_end_1
    ...
    .line 120
    :try_start_2
    invoke-virtual {v1, v8, v2, v5}, Lgnu/text/Lexer;->eofError(Ljava/lang/String;II)V

    :cond_6
    if-eqz v11, :cond_7

    .line 124
    const-string v2, "multiple \'.\' in list"

    invoke-virtual {v1, v2}, Lgnu/text/Lexer;->error(Ljava/lang/String;)V
    ...
    .line 140
    :goto_7
    invoke-virtual {v1, v15, v2, v7}, Lgnu/kawa/lispexpr/LispReader;->readValues(ILgnu/kawa/lispexpr/ReadTableEntry;Lgnu/kawa/lispexpr/ReadTable;)Ljava/lang/Object;
    ...
    .line 143
    :cond_9
    invoke-virtual {v1, v2, v7, v13, v14}, Lgnu/kawa/lispexpr/LispReader;->handlePostfix(Ljava/lang/Object;Lgnu/kawa/lispexpr/ReadTable;II)Ljava/lang/Object;
    ...
    .line 152
    const-string v2, "multiple values after \'.\'"
    ...
    .line 169
    :cond_c
    invoke-virtual {v1, v2, v13, v14}, Lgnu/kawa/lispexpr/LispReader;->makePair(Ljava/lang/Object;II)Lgnu/lists/Pair;
    ...
    .line 174
    :cond_d
    invoke-virtual {v1, v10, v2}, Lgnu/kawa/lispexpr/LispReader;->setCdr(Ljava/lang/Object;Ljava/lang/Object;)V
    :try_end_2
...
.method public read(Lgnu/text/Lexer;II)Ljava/lang/Object;
    ...
    .line 67
    invoke-virtual {p3}, Lgnu/text/LineBufferedReader;->getLineNumber()I

    move-result v0

    .line 68
    invoke-virtual {p3}, Lgnu/text/LineBufferedReader;->getColumnNumber()I
    ...
    invoke-virtual {p1, v1, v0, p3}, Lgnu/kawa/lispexpr/LispReader;->makePair(Ljava/lang/Object;II)Lgnu/lists/Pair;

    move-result-object p3

    .line 70
    invoke-virtual {p1, p3, p2}, Lgnu/kawa/lispexpr/LispReader;->setCdr(Ljava/lang/Object;Ljava/lang/Object;)V
